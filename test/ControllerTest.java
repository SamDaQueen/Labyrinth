...
public class ControllerTest {
  ...
  public void controllerCompleteRun() {
    ...
    assertEquals("\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [0,1]: Cave Available directions: [EAST] Treasures: [] Arrows: 0 \n"
                 ...
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [0,2]: Tunnel Available directions: [EAST, WEST] Arrows: 1 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "This will add a fine addition to your collection... Added to inventory :D \n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 4 arrows.\n"
                 + "Player is at location: [0,2]: Tunnel Available directions: [EAST, WEST] Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You are brave and attempt to advance in the dungeon... Moved to direction EAST\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 4 arrows.\n"
                 + "Player is at location: [0,3]: Tunnel Available directions: [SOUTH, WEST] Arrows: 0 \n"
                 ...
                 + "There is a faint stench... An Otyugh must be close!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You are brave and attempt to advance in the dungeon... Moved to direction SOUTH\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [1,3]: Tunnel Available directions: [NORTH, WEST] Arrows: 2 \n"
                 ...
                 + "This will add a fine addition to your collection... Added to inventory :D \n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 5 arrows.\n"
                 + "Player is at location: [1,3]: Tunnel Available directions: [NORTH, WEST] Arrows: 0 \n"
                 + "There is a strong stench... An Otyugh must be in the next cell!! Or perhaps there are "
                 + "more than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You have attempted to slay an Otyugh... Your have successfully hit the Otyugh twice "
                 + "and it is now dead!\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 4 arrows.\n"
                 + "Player is at location: [1,3]: Tunnel Available directions: [NORTH, WEST] Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You are brave and attempt to advance in the dungeon... Moved to direction WEST\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 4 arrows.\n"
                 + "Player is at location: [1,2]: Cave Available directions: [EAST, SOUTH, WEST] Treasures: "
                 + "[] Arrows: 0 \n"
                 + "There is a faint stench... An Otyugh must be close!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You have attempted to slay an Otyugh... Your arrow hit the Otyugh and you hear a piercing howl!\n"
                 ...
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [1,1]: Tunnel Available directions: [EAST, WEST] Arrows: 0 \n"
                 + "There is a strong stench... An Otyugh must be in the next cell!! Or perhaps there are "
                 + "more than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You have attempted to slay an Otyugh... Your have successfully hit the Otyugh twice "
                 + "and it is now dead!\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 2 arrows.\n"
                 + "Player is at location: [1,1]: Tunnel Available directions: [EAST, WEST] Arrows: 0 \n"
                 + "There is a faint stench... An Otyugh must be close!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You are brave and attempt to advance in the dungeon... Moved to direction WEST\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 2 arrows.\n"
                 + "Player is at location: [1,0]: Cave Available directions: [NORTH, EAST, SOUTH] Treasures: "
                 + "[] Arrows: 0 \n"
                 + "There is a strong stench... An Otyugh must be in the next cell!! Or perhaps there are "
                 + "more than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You have attempted to slay an Otyugh... Your arrow hit the Otyugh and you hear a piercing howl!\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 1 arrows.\n"
                 + "Player is at location: [1,0]: Cave Available directions: [NORTH, EAST, SOUTH] Treasures: "
                 + "[] Arrows: 0 \n"
                 ...
                 + "\n"
                 + "Player has collected with a score of 0 and has 0 arrows.\n"
                 + "Player is at location: [1,0]: Cave Available directions: [NORTH, EAST, SOUTH] Treasures: "
                 + "[] Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are "
                 + "brave and attempt to advance in the dungeon... Moved to direction NORTH\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 0 arrows.\n"
                 + "Player is at location: [0,0]: Cave Available directions: [SOUTH] Treasures: [] Arrows: 2 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are "
                 + "brave and attempt to advance in the dungeon... Moved to direction SOUTH\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 0 arrows.\n"
                 + "Player is at location: [1,0]: Cave Available directions: [NORTH, EAST, SOUTH] Treasures: [] "
                 + "Arrows: 0 \n"
                 ...
                 + "\n"
                 + "Player has collected with a score of 0 and has 0 arrows.\n"
                 + "Player is at location: [2,0]: Tunnel Available directions: [NORTH, SOUTH] Arrows: 3 \n"
                 ...
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [2,0]: Tunnel Available directions: [NORTH, SOUTH] Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are "
                 + "brave and attempt to advance in the dungeon... Moved to direction SOUTH\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [3,0]: Cave Available directions: [NORTH] Treasures: [] Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are "
                 + "brave and attempt to advance in the dungeon... Moved to direction NORTH\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 ...
                 + "Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are "
                 + "brave and attempt to advance in the dungeon... Moved to direction EAST\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [1,1]: Tunnel Available directions: [EAST, WEST] Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are "
                 ...
                 + "\n"
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [2,2]: Cave Available directions: [NORTH, EAST, SOUTH, WEST] Treasures: "
                 + "[RUBY, SAPPHIRE, DIAMOND] Arrows: 0 \n"
                 + "There is a strong stench... An Otyugh must be in the next cell!! Or perhaps there are more "
                 + "than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: This will "
                 + "add a fine addition to your collection... Added to inventory :D \n"
                 + "\n"
                 + "Player has collected DIAMOND(1), RUBY(1), SAPPHIRE(1), with a score of 60 and has 3 arrows.\n"
                 + "Player is at location: [2,2]: Cave Available directions: [NORTH, EAST, SOUTH, WEST] Treasures: "
                 + "[] Arrows: 0 \n"
                 + "There is a strong stench... An Otyugh must be in the next cell!! Or perhaps there are more "
                 + "than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are"
                 + " brave and attempt to advance in the dungeon... Moved to direction WEST\n"
                 + "\n"
                 + "Player has collected DIAMOND(1), RUBY(1), SAPPHIRE(1), with a score of 60 and has 3 arrows.\n"
                 + "Player is at location: [2,1]: Cave Available directions: [EAST] Treasures: [] Arrows: 0 \n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You are"
                 + " brave and attempt to advance in the dungeon... Moved to direction EAST\n"
                 + "\n"
                 + "Player has collected DIAMOND(1), RUBY(1), SAPPHIRE(1), with a score of 60 and has 3 arrows.\n"
                 ...
                 + "[DIAMOND, DIAMOND, RUBY, RUBY] Arrows: 3 \n"
                 + "There is a strong stench... An Otyugh must be in the next cell!! Or perhaps there are more "
                 + "than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: This will "
                 + "add a fine addition to your collection... Added to inventory :D \n"
  ...
  public void controllerKilledByOtyugh() {
    ...
    assertEquals("\n\n"
                 ...
                 + "Player is at location: [1,1]: Tunnel Available directions: [EAST, WEST] Arrows: 0 \n"
                 + "There is a faint stench... An Otyugh must be close!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You "
                 + "are brave and attempt to advance in the dungeon... Moved to direction WEST\n"
                 + "\n"
                 + "Player has collected with a score of 0 and has 2 arrows.\n"
                 + "Player is at location: [1,0]: Cave Available directions: [NORTH, EAST, SOUTH] Treasures: "
                 + "[] Arrows: 0 \n"
                 ...
                 + "than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: You "
                 + "are brave and attempt to advance in the dungeon... Moved to direction NORTH\n"
                 + "\n"
                 + "Sadly, you were devoured by the hungry Otyugh!! Your adventure ends :( Player has collected "
                 + "with a score of 0 and has 2 arrows.\n",
        out.toString());
  }
  ...
  public void pick() {
    ...
    assertTrue(out.toString().contains("Player has collected with a score of 0 and has 4 arrows."));
  }
  ...
  public void initialArrows() {
    ...
    new CommandController(in).execute(model, out);
    assertTrue(out.toString().contains("Player has collected with a score of 0 and has 3 arrows."));
  }
  ...
  public void extraCommands() {
    ...
    assertEquals("\n"
                 ...
                 + "Player has collected with a score of 0 and has 3 arrows.\n"
                 + "Player is at location: [1,3]: Tunnel Available directions: [NORTH, WEST] Arrows: 2 \n"
                 + "There is a strong stench... An Otyugh must be in the next cell!! Or perhaps there are more than one Otyughs nearby hungry for your flesh!!\n"
                 + "What do you wish to do? move [direction]/ pick/ shoot [direction] [distance]/ quit: "
                 + "You are brave and attempt to advance in the dungeon... Moved to direction WEST\n"
                 + "\n"
                 + "Sadly, you were devoured by the hungry Otyugh!! Your adventure ends :( Player has "
                 + "collected with a score of 0 and has 3 arrows.\n", out.toString());
  }
