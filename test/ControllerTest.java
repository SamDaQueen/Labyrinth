...
public class ControllerTest {
  ...
  public void controllerKilledByOtyugh() {
    ...
    assertEquals("\n\n"
                 ...
                 + " 0 \nWhat do you wish to do? move [direction]/ pick/ shoot [direction] "
                 + "[distance]/ quit: You are brave and attempt to advance in the dungeon..."
                 + " Moved to direction EAST\n\nPlayer has collected with a score of 0 and has "
                 ...
                 + " has collected with a score of 0 and has 4 arrows.\nPlayer is at location: "
                 ...
                 + " has collected with a score of 0 and has 3 arrows.\nPlayer is at location:"
                 ...
                 + "[distance]/ quit: You have attempted to slay an Otyugh... Your have "
                 + "successfully hit the Otyugh twice and it is now dead!\n\nPlayer has "
                 + "collected with a score of 0 and has 2 arrows.\nPlayer is at location:"
                 ...
                 + " has collected with a score of 0 and has 2 arrows.\nPlayer is at location:"
                 ...
                 + " Your adventure ends :( Player has collected with a score of 0 and has "
                 + "2 arrows.\n",
        out.toString());
  }
